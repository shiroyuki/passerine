...
from passerine.graph import DependencyNode as BaseDependencyNode, DependencyManager
from passerine.db.common    import Serializer, PseudoObjectId, ProxyObject
from passerine.db.entity    import BasicAssociation
from passerine.db.exception import UOWRepeatedRegistrationError, UOWUpdateError, UOWUnknownRecordError, IntegrityConstraintError
from passerine.db.mapper    import CascadingType
...
class UnitOfWork(object):
    ...
    def _compute_connection_changes(self, record):
        ...
        :type  record: passerine.db.uow.Record
        """
