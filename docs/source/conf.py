# -*- coding: utf-8 -*-
#
# Passerine documentation build configuration file, created by
...
project = u'Passerine ORM'
copyright = u'Juti Noppornpitak'
...
htmlhelp_basename = 'Passerinedoc'
...
latex_documents = [
  ('index', 'Passerine.tex', u'Passerine Documentation',
...
man_pages = [
    ('index', 'tori', u'Passerine Documentation',
...
texinfo_documents = [
  ('index', 'Passerine', u'Passerine Documentation',
   u'Juti Noppornpitak', 'Passerine', 'One line description of project.',
   'Miscellaneous'),
]
